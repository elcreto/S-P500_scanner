...
APP_NAME = "📈 S&P 500 Scanner v3.5 — SAFE MODE"
st.set_page_config(page_title=APP_NAME, layout="wide")
st.title(APP_NAME)
st.caption("Renders immediately. Click 'Start Scan' to run. Includes MACD/MACD‑V and Streamlit Cloud file watcher patch.")
...
# Embedded subset (extend as needed)
EMBEDDED_SP500 = ["AAPL","MSFT","GOOGL","AMZN","META","NVDA","JPM","XOM","LLY","V","MA",
                  "INTC","AMD","MU","ETN","ONTO","IONQ","META","MSFT","META"]
...
if start:
    ...
    st.write("🟡 Idle — click **Start Scan** to begin.")
